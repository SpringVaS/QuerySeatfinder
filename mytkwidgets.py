...
class TimeEntry(tk.Frame):
    def __init__(self, parent, font = None):
        ...
        self.hour = tk.Spinbox(self,from_=0,to=23,wrap=True,textvariable=self.hourstr,width=2,font = font)
        self.minstr=tk.StringVar(self,'30')
        self.minstr.trace("w",self.trace_var)
        self.last_value = ""
        self.min = tk.Spinbox(self,from_=0,to=59,wrap=True,textvariable=self.minstr,width=2,font = font)
        self.hour.grid()
    ...
    def getSelectedTime(self):
        timestr = self.hourstr + ':' + self.minstr
        return timestr